  ...
  return (
    ...
    >
      <svg className="sphere" viewBox="0 0 440 440" stroke="rgba(80,80,80,.35)">
        ...
        <path d="M300.175 299.808c-75.909 75.909-159.11 115.778-185.837 89.052-26.726-26.727 13.143-109.929 89.051-185.837 75.908-75.908 159.11-115.777 185.836-89.05 26.727 26.726-13.143 109.928-89.051 185.836z" />
        <path d="M284.707 284.34c-77.617 77.617-162.303 118.773-189.152 91.924-26.848-26.848 14.308-111.534 91.924-189.15C265.096 77.677 349.782 36.521 376.63 63.37c26.85 26.848-14.307 111.534-91.923 189.151z" />
        ...
        <path d="M157.427 157.061c-53.209 53.21-111.578 81.108-130.372 62.314-18.794-18.793 9.104-77.164 62.313-130.373 53.21-53.209 111.58-81.108 130.373-62.314 18.794 18.794-9.105 77.164-62.314 130.373z" />
...
// 確保 Anime.js 已安裝，如果沒有，請在 package.json 中添加
