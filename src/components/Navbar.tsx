    ...
    >
      ...
      <div className="md:hidden">
        ...
        <button
          ...
          className="mr-8 p-2 rounded-md ring-2 ring-inset ring-gray-500 focus:outline-none"
      ...
      {isMenuOpen && (
        // 只有在選單開啟時才渲染
        <div className="md:hidden absolute top-full right-2 w-30 bg-transparent shadow-lg z-10 mr-10">
